...
namespace ReminderManager.Infrastructure.Migrations
{
    ...
    [Migration("20251112082606_CreateThresholdTable")]
    partial class CreateThresholdTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReminderManager.Domain.Entities.Threshold", b =>
                {
                    ...
                    b.Property<double>("MessageThresholdAccelerationX")
                        .HasColumnType("double")
                        .HasColumnName("message_threshold_acceleration_x");

                    b.Property<double>("MessageThresholdAccelerationZ")
                        .HasColumnType("double")
                        .HasColumnName("message_threshold_acceleration_z");

                    b.Property<double>("MessageThresholdTemperature")
                        .HasColumnType("double")
            ...
            modelBuilder.Entity("ReminderManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("541cb656-56c0-42b3-8972-cbfa3444ed76"),
                            Password = "$2a$11$KfEK7wcdlXXXlIOkSGAqQORhi5uUejmr1plYoQPtLLt8u2lgMVtQW",
                            Username = "Admin"
                        });
                });

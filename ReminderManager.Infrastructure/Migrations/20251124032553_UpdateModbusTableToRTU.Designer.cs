...
namespace ReminderManager.Infrastructure.Migrations
{
    ...
    [Migration("20251124032553_UpdateModbusTableToRTU")]
    partial class UpdateModbusTableToRTU
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReminderManager.Domain.Entities.Threshold", b =>
                {
                    ...
                    b.Property<string>("MessageThresholdAccelerationY")
                        .HasColumnType("longtext")
                        .HasColumnName("message_threshold_acceleration_y");
                    ...
                    b.Property<string>("MessageThresholdVelocityY")
                        .HasColumnType("longtext")
                        .HasColumnName("message_threshold_velocity_y");
                    ...
                    b.Property<double>("ThresholdAccelerationY")
                        .HasColumnType("double")
                        .HasColumnName("threshold_acceleration_y");
                    ...
                    b.Property<double>("ThresholdVelocityY")
                        .HasColumnType("double")
                        .HasColumnName("threshold_velocity_y");
            ...
            modelBuilder.Entity("ReminderManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("52c566f5-6a4d-4e8e-a9b7-e1ecf68b4bb2"),
                            Password = "$2a$11$DhC05JvSZVy2fzH83XRRg.ziniXJqcdMl3YxQ4HlGE9jZqZPdrhaS",
                            Username = "Admin"
                        });
                });

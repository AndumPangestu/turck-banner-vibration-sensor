...
namespace ReminderManager.Infrastructure.Migrations
{
    ...
    [Migration("20251117040541_AddThresholdEventTable")]
    partial class AddThresholdEventTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReminderManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5368b86c-130d-4fd5-8468-9656eb967579"),
                            Password = "$2a$11$uO2LRd5T9a/UOuVjryCufOACrklZngjHOtcyq3E8aduLhxh0h3wCm",
                            Username = "Admin"
                        });
                });
